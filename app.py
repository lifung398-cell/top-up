...
BANK_ACCOUNT    = os.getenv("BANK_ACCOUNT", "your_name@bank")
MERCHANT_NAME   = os.getenv("MERCHANT_NAME", "Your Business Name")
MERCHANT_CITY   = os.getenv("MERCHANT_CITY", "Phnom Penh")
CURRENCY        = os.getenv("CURRENCY", "USD")
STORE_LABEL     = os.getenv("STORE_LABEL", "MyShop")
PHONE_NUMBER    = os.getenv("PHONE_NUMBER", "85512345678")
