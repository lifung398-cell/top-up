...
class CryptoBotService:
    ...
    def __init__(self):
        ...
        self.api_key = settings.8427975341:AAFPGUl7FUgsJBjCipUwn0anHmsjVhblznQ
        self.base_url = " https://khpay.site/api/v1"
    ...
    def generate_payment_address(self, amount: float, transaction_id: int, crypto_currency: str = None, crypto_network: str = None) -> str:
        ...
        if not self.api_key:
            ...
            return f"{transaction_id}|https://t.me/KHQRAPI_BOT_{transaction_id}"
        ...
        try:
            ...
            payload = {
                ...
                "paid_btn_url": f"https://t.me/KHQRAPI_BOT_{transaction_id}",
